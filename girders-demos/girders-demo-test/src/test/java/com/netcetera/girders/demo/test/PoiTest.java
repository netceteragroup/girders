...
class PoiTest {
  ...
  @SneakyThrows
  void testExcel() {
    String url = "http://localhost:" + port + "/demo-showcase/poi/file.xls";
    ...
    assertThat(response.getHeaders().getContentType().isCompatibleWith(MimeType.valueOf("application/vnd.ms-excel")),
        is(true));
  }
